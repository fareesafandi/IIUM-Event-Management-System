                        ...
                        <div class="p-6 hover:bg-gray-50 transition-colors border-l-4 {{ $event->status === 'open' || $event->status === 'upcoming' ? 'border-teal-500' : ($event->status === 'ongoing' ? 'border-green-500' : 'border-gray-400') }}">
                            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                ...
                                <div class="flex items-center gap-2">
                                    <a href="{{ route('manager.events.participants', $event) }}" class="inline-flex items-center px-3 py-1.5 bg-teal-500 hover:bg-teal-600 text-white text-sm font-medium rounded transition-colors" title="View Participants">
                                        ...
                                        @endphp
                                        @if($pendingCount > 0)
                                            <span class="ml-1 px-1.5 py-0.5 bg-yellow-400 text-yellow-900 text-xs font-bold rounded-full">{{ $pendingCount }}</span>
                                        @endif
                                    </a>
