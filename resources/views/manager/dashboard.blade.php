            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $totalEvents }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $upcomingEvents }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Past Events</dt>
                                <dd class="text-2xl font-semibold text-gray-900 dark:text-gray-100">{{ $pastEvents }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                                ...
                                @foreach($recentEvents as $event)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('manager.events.edit', $event) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 mr-3">
                                                Edit
                                            </a>
                                            <a href="{{ route('manager.events.participants', $event) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400">
                                                View
                                            </a>
                                        </td>
                                    </tr>
